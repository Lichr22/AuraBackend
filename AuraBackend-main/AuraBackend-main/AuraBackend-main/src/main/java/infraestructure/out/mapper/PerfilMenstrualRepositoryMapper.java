...
public class PerfilMenstrualRepositoryMapper {
    ...
    public PerfilMenstrualRepositoryMapper() {
    }

    public PerfilMenstrualRepositoryMapper(int idPerfil, Usuario usuario, Integer edad, Integer cicloPromedio,
    ...
    public PerfilMenstrualRepositoryMapper createPerfil(PerfilMenstrualRepositoryMapper perfil){
    ...
    public PerfilMenstrualRepositoryMapper updatePerfil(PerfilMenstrualRepositoryMapper perfil){
    ...
    public List<PerfilMenstrualRepositoryMapper> getAllPerfiles(){
        return null;
    }

    public void getPerfilById(int idPerfil, PerfilMenstrualRepositoryMapper perfil){
