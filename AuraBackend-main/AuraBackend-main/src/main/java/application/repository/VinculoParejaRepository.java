...
public class VinculoParejaRepository {
    ...
    public VinculoParejaRepository(Long idVinculoPareja, Usuario mujer, Usuario pareja, String estadoVinculo, LocalDate fechaVinculacion) {
    ...
    public VinculoParejaRepository() {
    }
    ...
    public VinculoParejaRepository createVinculo(VinculoParejaRepository vinculo) {
    ...
    public VinculoParejaRepository updateVinculo(VinculoParejaRepository vinculo) {
    ...
    public List<VinculoParejaRepository> getAllVinculos() {
        return null;
    }

    public void getVinculoById(int idVinculoPareja, VinculoParejaRepository vinculo) {
