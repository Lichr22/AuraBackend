...
public class PerfilMenstrualRepository {
    ...
    public PerfilMenstrualRepository() {
    }

    public PerfilMenstrualRepository(int idPerfil, Usuario usuario, Integer edad, Integer cicloPromedio,
    ...
    public PerfilMenstrualRepository createPerfil(PerfilMenstrualRepository perfil){
    ...
    public PerfilMenstrualRepository updatePerfil(PerfilMenstrualRepository perfil){
    ...
    public List<PerfilMenstrualRepository> getAllPerfiles(){
        return null;
    }

    public void getPerfilById(int idPerfil, PerfilMenstrualRepository perfil){
