...
public class CicloRepositoryMapper {
    ...
    public CicloRepositoryMapper(){

    }

    public CicloRepositoryMapper(int idCiclo, Usuario usuario, LocalDate fechaInicio, LocalDate fechaFin,
    ...
    public CicloRepositoryMapper(int idCiclo){
        this.idCiclo = idCiclo;
    }
    ...
    public CicloRepositoryMapper createCiclo(CicloRepositoryMapper ciclo){
    ...
    public void getCicloById(int id , CicloRepositoryMapper ciclo){
