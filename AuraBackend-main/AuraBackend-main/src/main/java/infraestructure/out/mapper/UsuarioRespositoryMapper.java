...
public class UsuarioRespositoryMapper {
    ...
    public UsuarioRespositoryMapper() {
    }



    public UsuarioRespositoryMapper(int idUsuario, String nombre, String email, String contrasenaHash, String rol,
    ...
    public UsuarioRespositoryMapper createUser(UsuarioRespositoryMapper usuario){
    ...
    public UsuarioRespositoryMapper updateUser(UsuarioRespositoryMapper usuario){
    ...
    public List<UsuarioRespositoryMapper> getAllUsers(){
        return null;
    }

    public void getUserById(int idUsuario, UsuarioRespositoryMapper usuario){
