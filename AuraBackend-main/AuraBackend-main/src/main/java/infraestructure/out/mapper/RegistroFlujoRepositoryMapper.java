...
public class RegistroFlujoRepositoryMapper {
    ...
    //CONSTRUCTORES
//Vacio
    public RegistroFlujoRepositoryMapper() {
    }

    //Con los atributos
    public RegistroFlujoRepositoryMapper(int idFlujo, RegistroDiario registro, String tipoTextura, String color, String cantidad) {
    ...
    //Solo ID
    public RegistroFlujoRepositoryMapper(int idFlujo) {
        this.idFlujo = idFlujo;
    }
...
// METODOS
    ...
    public RegistroFlujoRepositoryMapper createRegistroFlujo(RegistroFlujoRepositoryMapper flujo){
