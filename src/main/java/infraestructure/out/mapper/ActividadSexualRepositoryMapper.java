...
public class ActividadSexualRepositoryMapper {
    ...
    // CONSTRUCTORES
    //Vacio
    public ActividadSexualRepositoryMapper() {
    }

    // Constructor con todos los atributos
    public ActividadSexualRepositoryMapper(int idActividad, RegistroDiario registroDiario, Boolean usoPreservativo, Boolean orgasmo, String metodoAdicional) {
    ...
    public ActividadSexualRepositoryMapper(int idActividad) {
        this.idActividad = idActividad;
    }
    ...
    public ActividadSexualRepositoryMapper createActividadSexual(ActividadSexualRepositoryMapper actividad){
