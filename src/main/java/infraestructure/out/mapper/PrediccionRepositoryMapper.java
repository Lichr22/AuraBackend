...
public class PrediccionRepositoryMapper {
    ...
    // CONSTRUCTORES
//Vacio
    public PrediccionRepositoryMapper() {
    }

    //Con atributos
    public PrediccionRepositoryMapper(int idPrediccion, Usuario usuario, LocalDate fechaCalculo,
    ...
    //Solo ID
    public PrediccionRepositoryMapper(int idPrediccion) {
        this.idPrediccion = idPrediccion;
    }
...
// METODOS
    ...
    public PrediccionRepositoryMapper createPrediccion(PrediccionRepositoryMapper prediccion) {
