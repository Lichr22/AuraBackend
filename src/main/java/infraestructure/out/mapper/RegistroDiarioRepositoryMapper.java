...
public class RegistroDiarioRepositoryMapper {
    ...
    public RegistroDiarioRepositoryMapper() {

    }

    public RegistroDiarioRepositoryMapper(int idRegistro, Usuario usuario, Ciclo ciclo, LocalDate fecha,
