...
public class VinculoParejaRepositoryMapper {
    ...
    public VinculoParejaRepositoryMapper(Long idVinculoPareja, Usuario mujer, Usuario pareja, String estadoVinculo, LocalDate fechaVinculacion) {
    ...
    public VinculoParejaRepositoryMapper() {
    }
    ...
    public VinculoParejaRepositoryMapper createVinculo(VinculoParejaRepositoryMapper vinculo) {
    ...
    public VinculoParejaRepositoryMapper updateVinculo(VinculoParejaRepositoryMapper vinculo) {
    ...
    public List<VinculoParejaRepositoryMapper> getAllVinculos() {
        return null;
    }

    public void getVinculoById(int idVinculoPareja, VinculoParejaRepositoryMapper vinculo) {
