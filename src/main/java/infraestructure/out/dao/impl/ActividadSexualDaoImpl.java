...
public class ActividadSexualDaoImpl implements ActividadSexualDao {
    ...
    @Override
    public ActividadSexual update(Integer id, ActividadSexual a) {
    ...
    @Override
    public Optional<ActividadSexual> findById(Integer id) {
    ...
    @Override
    public List<ActividadSexual> findAll() {
