...
public class RegistroFlujoDaoImpl implements RegistroFlujoDao {
    ...
    @Override
    public RegistroFlujo update(Integer id, RegistroFlujo f) {
    ...
    @Override
    public Optional<RegistroFlujo> findById(Integer id) {
    ...
    @Override
    public List<RegistroFlujo> findAll() {
