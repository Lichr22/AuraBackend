...
public class UsuarioRespositoryDb {
    ...
    public UsuarioRespositoryDb() {
    }



    public UsuarioRespositoryDb(int idUsuario, String nombre, String email, String contrasenaHash, String rol,
    ...
    public UsuarioRespositoryDb createUser(UsuarioRespositoryDb usuario){
    ...
    public UsuarioRespositoryDb updateUser(UsuarioRespositoryDb usuario){
    ...
    public List<UsuarioRespositoryDb> getAllUsers(){
        return null;
    }

    public void getUserById(int idUsuario, UsuarioRespositoryDb usuario){
